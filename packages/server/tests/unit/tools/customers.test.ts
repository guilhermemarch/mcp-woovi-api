...
describe('Customer Tools', () => {
  ...
  describe('Tool Registration', () => {
    ...
    it('should register get_customer tool with correct name and description', () => {
      ...
      expect(getCustomerTool.description).toContain('correlation ID or tax ID');
    });
    ...
    it('should register list_customers tool with correct name and description', () => {
      ...
      expect(listCustomersTool.description).toContain('List customers');
  ...
  describe('create_customer validation', () => {
    it('should validate required name field', () => {
      ...
      // Valid input should parse when at least one contact identifier is present
      const validInput = { name: 'Test Customer', email: 'test@example.com' };
      ...
      expect(() => schema.parse({ name: 'Test Customer' })).toThrow();
    });
